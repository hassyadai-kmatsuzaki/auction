  ...
  return (
    <Box>
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" gutterBottom>
          全出品（未落札含む）を出品単位で出力。オークションを選択するか、期間で絞り込めます。落札済みの行のみ金額列（落札金額・落札者/出品者手数料・送料・消費税3区分・落札者請求合計・出品者支払合計）が入り、消費税はインボイス有/無の該当区分のみに出力します。消費税は生体単位で丸めるため、帳票単位で丸めるサマリーCSVとは合計が一致しない場合があります。各生体の行動分析（閲覧数・閲覧UU・お気に入り数・指値数）も付与します（テストユーザーは除外）。
        </Typography>
        <Divider sx={{ my: 2 }} />
        <Grid container spacing={2} alignItems="center">
